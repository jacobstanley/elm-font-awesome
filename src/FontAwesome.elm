...
{-| This module exposes 694 scalable vector icons as Elm HTML
components.
...
{-|-}
align_center : Color -> Int -> Html msg
...
{-|-}
align_justify : Color -> Int -> Html msg
...
{-|-}
align_right : Color -> Int -> Html msg
...
{-|-}
angle_right : Color -> Int -> Html msg
...
{-|-}
arrow_circle_left : Color -> Int -> Html msg
...
{-|-}
arrow_circle_o_down : Color -> Int -> Html msg
...
{-|-}
arrow_circle_o_left : Color -> Int -> Html msg
...
{-|-}
arrow_circle_right : Color -> Int -> Html msg
...
{-|-}
arrow_circle_up : Color -> Int -> Html msg
...
{-|-}
arrow_right : Color -> Int -> Html msg
...
{-|-}
balance_scale : Color -> Int -> Html msg
...
{-|-}
bar_chart_o : Color -> Int -> Html msg
...
{-|-}
battery_empty : Color -> Int -> Html msg
...
{-|-}
battery_three_quarters : Color -> Int -> Html msg
...
{-|-}
behance_square : Color -> Int -> Html msg
...
{-|-}
bell_slash_o : Color -> Int -> Html msg
...
{-|-}
birthday_cake : Color -> Int -> Html msg
...
{-|-}
bitbucket_square : Color -> Int -> Html msg
...
{-|-}
black_tie : Color -> Int -> Html msg
black_tie = icon "M128 128h1536v1536h-1536v-1536zm1085 1115l-221-631 221-297h-634l221 297-221 631 317 304z"

{-|-}
bluetooth_b : Color -> Int -> Html msg
bluetooth_b = icon "M980 1423l173-172-173-172v344zm0-710l173-172-173-172v344zm32 183l356 356-539 540v-711l-297 296-108-108 372-373-372-373 108-108 297 296v-711l539 540z"

{-|-}
bluetooth : Color -> Int -> Html msg
bluetooth = icon "M969 1053l148 148-149 149zm-1-611l149 149-148 148zm-130 1224l464-464-306-306 306-306-464-464v611l-255-255-93 93 320 321-320 321 93 93 255-255v611zm719-770q0 209-32 365.5t-87.5 257-140.5 162.5-181.5 86.5-219.5 24.5-219.5-24.5-181.5-86.5-140.5-162.5-87.5-257-32-365.5 32-365.5 87.5-257 140.5-162.5 181.5-86.5 219.5-24.5 219.5 24.5 181.5 86.5 140.5 162.5 87.5 257 32 365.5z"

{-|-}
bold : Color -> Int -> Html msg
...
{-|-}
btc : Color -> Int -> Html msg
btc = icon "M1423 640q18 182-131 258 117 28 175 103t45 214q-7 71-32.5 125t-64.5 89-97 58.5-121.5 34.5-145.5 15v255h-154v-251q-80 0-122-1v252h-154v-255q-18 0-54-.5t-55-.5h-200l31-183h111q50 0 58-51v-402h16q-6-1-16-1v-287q-13-68-89-68h-111v-164l212 1q64 0 97-1v-252h154v247q82-2 122-2v-245h154v252q79 7 140 22.5t113 45 82.5 78 36.5 114.5zm-215 545q0-36-15-64t-37-46-57.5-30.5-65.5-18.5-74-9-69-3-64.5 1-47.5 1v338q8 0 37 .5t48 .5 53-1.5 58.5-4 57-8.5 55.5-14 47.5-21 39.5-30 24.5-40 9.5-51zm-71-476q0-33-12.5-58.5t-30.5-42-48-28-55-16.5-61.5-8-58-2.5-54 1-39.5.5v307q5 0 34.5.5t46.5 0 50-2 55-5.5 51.5-11 48.5-18.5 37-27 27-38.5 9-51z"

{-|-}
bug : Color -> Int -> Html msg
...
{-|-}
calendar_check_o : Color -> Int -> Html msg
...
{-|-}
calendar_minus_o : Color -> Int -> Html msg
...
{-|-}
calendar_times_o : Color -> Int -> Html msg
...
{-|-}
camera_retro : Color -> Int -> Html msg
...
{-|-}
caret_square_o_down : Color -> Int -> Html msg
...
{-|-}
caret_square_o_left : Color -> Int -> Html msg
...
{-|-}
caret_square_o_right : Color -> Int -> Html msg
...
{-|-}
caret_square_o_up : Color -> Int -> Html msg
...
{-|-}
cc_diners_club : Color -> Int -> Html msg
...
{-|-}
cc_discover : Color -> Int -> Html msg
...
{-|-}
cc_mastercard : Color -> Int -> Html msg
...
{-|-}
certificate : Color -> Int -> Html msg
...
{-|-}
chain_broken : Color -> Int -> Html msg
...
{-|-}
check_circle_o : Color -> Int -> Html msg
...
{-|-}
check_square : Color -> Int -> Html msg
...
{-|-}
chevron_circle_down : Color -> Int -> Html msg
...
{-|-}
chevron_circle_left : Color -> Int -> Html msg
...
{-|-}
chevron_circle_right : Color -> Int -> Html msg
...
{-|-}
chevron_circle_up : Color -> Int -> Html msg
...
{-|-}
chevron_down : Color -> Int -> Html msg
...
{-|-}
chevron_left : Color -> Int -> Html msg
...
{-|-}
chevron_right : Color -> Int -> Html msg
...
{-|-}
circle_o_notch : Color -> Int -> Html msg
circle_o_notch = icon "M1760 896q0 176-68.5 336t-184 275.5-275.5 184-336 68.5-336-68.5-275.5-184-184-275.5-68.5-336q0-213 97-398.5t265-305.5 374-151v228q-221 45-366.5 221t-145.5 406q0 130 51 248.5t136.5 204 204 136.5 248.5 51 248.5-51 204-136.5 136.5-204 51-248.5q0-230-145.5-406t-366.5-221v-228q206 31 374 151t265 305.5 97 398.5z"

{-|-}
circle_o : Color -> Int -> Html msg
...
{-|-}
circle_thin : Color -> Int -> Html msg
...
{-|-}
compass : Color -> Int -> Html msg
compass = icon "M768 1088l256-128-256-128v256zm384-591v542l-512 256v-542zm288 399q0-148-73-273t-198-198-273-73-273 73-198 198-73 273 73 273 198 198 273 73 273-73 198-198 73-273zm224 0q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z"

{-|-}
compress : Color -> Int -> Html msg
...
{-|-}
connectdevelop : Color -> Int -> Html msg
...
{-|-}
creative_commons : Color -> Int -> Html msg
...
{-|-}
credit_card_alt : Color -> Int -> Html msg
credit_card_alt = icon "M-256 1504v-608h2304v608q0 66-47 113t-113 47h-1984q-66 0-113-47t-47-113zm640-224v128h384v-128h-384zm-384 0v128h256v-128h-256zm1888-1152q66 0 113 47t47 113v224h-2304v-224q0-66 47-113t113-47h1984z"

{-|-}
credit_card : Color -> Int -> Html msg
...
{-|-}
dot_circle_o : Color -> Int -> Html msg
...
{-|-}
envelope_square : Color -> Int -> Html msg
...
{-|-}
expeditedssl : Color -> Int -> Html msg
...
{-|-}
external_link_square : Color -> Int -> Html msg
...
{-|-}
external_link : Color -> Int -> Html msg
...
{-|-}
facebook_official : Color -> Int -> Html msg
...
{-|-}
facebook_square : Color -> Int -> Html msg
...
{-|-}
fast_backward : Color -> Int -> Html msg
...
{-|-}
fast_forward : Color -> Int -> Html msg
...
{-|-}
fighter_jet : Color -> Int -> Html msg
...
{-|-}
file_archive_o : Color -> Int -> Html msg
...
{-|-}
file_audio_o : Color -> Int -> Html msg
...
{-|-}
file_code_o : Color -> Int -> Html msg
...
{-|-}
file_excel_o : Color -> Int -> Html msg
...
{-|-}
file_movie_o : Color -> Int -> Html msg
...
{-|-}
file_photo_o : Color -> Int -> Html msg
...
{-|-}
file_picture_o : Color -> Int -> Html msg
...
{-|-}
file_powerpoint_o : Color -> Int -> Html msg
...
{-|-}
file_sound_o : Color -> Int -> Html msg
...
{-|-}
file_video_o : Color -> Int -> Html msg
file_video_o = icon "M1596 380q28 28 48 76t20 88v1152q0 40-28 68t-68 28h-1344q-40 0-68-28t-28-68v-1600q0-40 28-68t68-28h896q40 0 88 20t76 48zm-444-244v376h376q-10-29-22-41l-313-313q-12-12-41-22zm384 1528v-1024h-416q-40 0-68-28t-28-68v-416h-768v1536h1280zm-640-896q52 0 90 38t38 90v384q0 52-38 90t-90 38h-384q-52 0-90-38t-38-90v-384q0-52 38-90t90-38h384zm492 2q20 8 20 30v576q0 22-20 30-8 2-12 2-14 0-23-9l-265-266v-90l265-266q9-9 23-9 4 0 12 2z"

{-|-}
file_word_o : Color -> Int -> Html msg
...
{-|-}
fire_extinguisher : Color -> Int -> Html msg
...
{-|-}
flag_checkered : Color -> Int -> Html msg
...
{-|-}
folder_open_o : Color -> Int -> Html msg
...
{-|-}
folder_open : Color -> Int -> Html msg
...
{-|-}
github_square : Color -> Int -> Html msg
...
{-|-}
google_plus_square : Color -> Int -> Html msg
google_plus_square = icon "M1045 905q0-26-6-64h-362v132h217q-3 24-16.5 50t-37.5 53-66.5 44.5-96.5 17.5q-99 0-169-71t-70-171 70-171 169-71q92 0 153 59l104-101q-108-100-257-100-160 0-272 112.5t-112 271.5 112 271.5 272 112.5q165 0 266.5-105t101.5-270zm345 46h109v-110h-109v-110h-110v110h-110v110h110v110h110v-110zm274-535v960q0 119-84.5 203.5t-203.5 84.5h-960q-119 0-203.5-84.5t-84.5-203.5v-960q0-119 84.5-203.5t203.5-84.5h960q119 0 203.5 84.5t84.5 203.5z"

{-|-}
google_plus : Color -> Int -> Html msg
google_plus = icon "M1181 913q0 208-87 370.5t-248 254-369 91.5q-149 0-285-58t-234-156-156-234-58-285 58-285 156-234 234-156 285-58q286 0 491 192l-199 191q-117-113-292-113-123 0-227.5 62t-165.5 168.5-61 232.5 61 232.5 165.5 168.5 227.5 62q83 0 152.5-23t114.5-57.5 78.5-78.5 49-83 21.5-74h-416v-252h692q12 63 12 122zm867-122v210h-209v209h-210v-209h-209v-210h209v-209h210v209h209z"

{-|-}
google_wallet : Color -> Int -> Html msg
...
{-|-}
google : Color -> Int -> Html msg
google = icon "M896 786h725q12 67 12 128 0 217-91 387.5t-259.5 266.5-386.5 96q-157 0-299-60.5t-245-163.5-163.5-245-60.5-299 60.5-299 163.5-245 245-163.5 299-60.5q300 0 515 201l-209 201q-123-119-306-119-129 0-238.5 65t-173.5 176.5-64 243.5 64 243.5 173.5 176.5 238.5 65q87 0 160-24t120-60 82-82 51.5-87 22.5-78h-436v-264z"

{-|-}
graduation_cap : Color -> Int -> Html msg
...
{-|-}
gratipay : Color -> Int -> Html msg
gratipay = icon "M901 1302l350-473q16-22 24.5-59t-6-85-61.5-79q-40-26-83-25.5t-73.5 17.5-54.5 45q-36 40-96 40-59 0-95-40-24-28-54.5-45t-73.5-17.5-84 25.5q-46 31-60.5 79t-6 85 24.5 59zm763-406q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z"

{-|-}
group : Color -> Int -> Html msg
...
{-|-}
hacker_news : Color -> Int -> Html msg
...
{-|-}
hand_grab_o : Color -> Int -> Html msg
...
{-|-}
hand_lizard_o : Color -> Int -> Html msg
...
{-|-}
hand_o_down : Color -> Int -> Html msg
...
{-|-}
hand_o_left : Color -> Int -> Html msg
...
{-|-}
hand_o_right : Color -> Int -> Html msg
...
{-|-}
hand_paper_o : Color -> Int -> Html msg
...
{-|-}
hand_peace_o : Color -> Int -> Html msg
...
{-|-}
hand_pointer_o : Color -> Int -> Html msg
...
{-|-}
hand_rock_o : Color -> Int -> Html msg
...
{-|-}
hand_scissors_o : Color -> Int -> Html msg
...
{-|-}
hand_spock_o : Color -> Int -> Html msg
...
{-|-}
hand_stop_o : Color -> Int -> Html msg
...
{-|-}
hourglass_1 : Color -> Int -> Html msg
...
{-|-}
hourglass_2 : Color -> Int -> Html msg
...
{-|-}
hourglass_3 : Color -> Int -> Html msg
...
{-|-}
hourglass_start : Color -> Int -> Html msg
hourglass_start = icon "M1536 128q0 261-106.5 461.5t-266.5 306.5q160 106 266.5 306.5t106.5 461.5h96q14 0 23 9t9 23v64q0 14-9 23t-23 9h-1472q-14 0-23-9t-9-23v-64q0-14 9-23t23-9h96q0-261 106.5-461.5t266.5-306.5q-160-106-266.5-306.5t-106.5-461.5h-96q-14 0-23-9t-9-23v-64q0-14 9-23t23-9h1472q14 0 23 9t9 23v64q0 14-9 23t-23 9h-96zm-128 0h-1024q0 66 9 128h1006q9-61 9-128zm0 1536q0-130-34-249.5t-90.5-208-126.5-152-146-94.5h-230q-76 31-146 94.5t-126.5 152-90.5 208-34 249.5h1024z"

{-|-}
hourglass : Color -> Int -> Html msg
...
{-|-}
institution : Color -> Int -> Html msg
...
{-|-}
life_buoy : Color -> Int -> Html msg
life_buoy = icon "M896 0q182 0 348 71t286 191 191 286 71 348-71 348-191 286-286 191-348 71-348-71-286-191-191-286-71-348 71-348 191-286 286-191 348-71zm0 128q-190 0-361 90l194 194q82-28 167-28t167 28l194-194q-171-90-361-90zm-678 1129l194-194q-28-82-28-167t28-167l-194-194q-90 171-90 361t90 361zm678 407q190 0 361-90l-194-194q-82 28-167 28t-167-28l-194 194q171 90 361 90zm0-384q159 0 271.5-112.5t112.5-271.5-112.5-271.5-271.5-112.5-271.5 112.5-112.5 271.5 112.5 271.5 271.5 112.5zm484-217l194 194q90-171 90-361t-90-361l-194 194q28 82 28 167t-28 167z"

{-|-}
life_ring : Color -> Int -> Html msg
life_ring = icon "M896 0q182 0 348 71t286 191 191 286 71 348-71 348-191 286-286 191-348 71-348-71-286-191-191-286-71-348 71-348 191-286 286-191 348-71zm0 128q-190 0-361 90l194 194q82-28 167-28t167 28l194-194q-171-90-361-90zm-678 1129l194-194q-28-82-28-167t28-167l-194-194q-90 171-90 361t90 361zm678 407q190 0 361-90l-194-194q-82 28-167 28t-167-28l-194 194q171 90 361 90zm0-384q159 0 271.5-112.5t112.5-271.5-112.5-271.5-271.5-112.5-271.5 112.5-112.5 271.5 112.5 271.5 271.5 112.5zm484-217l194 194q90-171 90-361t-90-361l-194 194q28 82 28 167t-28 167z"

{-|-}
life_saver : Color -> Int -> Html msg
life_saver = icon "M896 0q182 0 348 71t286 191 191 286 71 348-71 348-191 286-286 191-348 71-348-71-286-191-191-286-71-348 71-348 191-286 286-191 348-71zm0 128q-190 0-361 90l194 194q82-28 167-28t167 28l194-194q-171-90-361-90zm-678 1129l194-194q-28-82-28-167t28-167l-194-194q-90 171-90 361t90 361zm678 407q190 0 361-90l-194-194q-82 28-167 28t-167-28l-194 194q171 90 361 90zm0-384q159 0 271.5-112.5t112.5-271.5-112.5-271.5-271.5-112.5-271.5 112.5-112.5 271.5 112.5 271.5 271.5 112.5zm484-217l194 194q90-171 90-361t-90-361l-194 194q28 82 28 167t-28 167z"

{-|-}
lightbulb_o : Color -> Int -> Html msg
...
{-|-}
location_arrow : Color -> Int -> Html msg
...
{-|-}
long_arrow_down : Color -> Int -> Html msg
...
{-|-}
long_arrow_left : Color -> Int -> Html msg
...
{-|-}
long_arrow_right : Color -> Int -> Html msg
...
{-|-}
long_arrow_up : Color -> Int -> Html msg
...
{-|-}
mail_forward : Color -> Int -> Html msg
...
{-|-}
mail_reply_all : Color -> Int -> Html msg
...
{-|-}
mars_double : Color -> Int -> Html msg
...
{-|-}
mars_stroke_h : Color -> Int -> Html msg
...
{-|-}
mars_stroke_v : Color -> Int -> Html msg
...
{-|-}
mars_stroke : Color -> Int -> Html msg
...
{-|-}
microphone_slash : Color -> Int -> Html msg
...
{-|-}
minus_circle : Color -> Int -> Html msg
...
{-|-}
modx : Color -> Int -> Html msg
modx = icon "M1427 709l-614-386 92-151h855zm-1022 265l-184-116v-858l1183 743zm1019-135l147 95v858l-532-335zm-37-21l-500 802h-855l356-571z"

{-|-}
money : Color -> Int -> Html msg
...
{-|-}
mouse_pointer : Color -> Int -> Html msg
...
{-|-}
newspaper_o : Color -> Int -> Html msg
...
{-|-}
object_group : Color -> Int -> Html msg
...
{-|-}
object_ungroup : Color -> Int -> Html msg
...
{-|-}
odnoklassniki_square : Color -> Int -> Html msg
...
{-|-}
odnoklassniki : Color -> Int -> Html msg
...
{-|-}
paper_plane : Color -> Int -> Html msg
...
{-|-}
pencil_square_o : Color -> Int -> Html msg
...
{-|-}
pencil_square : Color -> Int -> Html msg
...
{-|-}
percent : Color -> Int -> Html msg
percent = icon "M1408 1280q0-52-38-90t-90-38-90 38-38 90 38 90 90 38 90-38 38-90zm-768-768q0-52-38-90t-90-38-90 38-38 90 38 90 90 38 90-38 38-90zm1024 768q0 159-112.5 271.5t-271.5 112.5-271.5-112.5-112.5-271.5 112.5-271.5 271.5-112.5 271.5 112.5 112.5 271.5zm-96-1088q0 20-13 38l-1056 1408q-19 26-51 26h-160q-26 0-45-19t-19-45q0-20 13-38l1056-1408q19-26 51-26h160q26 0 45 19t19 45zm-672 320q0 159-112.5 271.5t-271.5 112.5-271.5-112.5-112.5-271.5 112.5-271.5 271.5-112.5 271.5 112.5 112.5 271.5z"

{-|-}
phone_square : Color -> Int -> Html msg
...
{-|-}
photo : Color -> Int -> Html msg
photo = icon "M576 576q0 80-56 136t-136 56-136-56-56-136 56-136 136-56 136 56 56 136zm1024 384v448h-1408v-192l320-320 160 160 512-512zm96-704h-1600q-13 0-22.5 9.5t-9.5 22.5v1216q0 13 9.5 22.5t22.5 9.5h1600q13 0 22.5-9.5t9.5-22.5v-1216q0-13-9.5-22.5t-22.5-9.5zm160 32v1216q0 66-47 113t-113 47h-1600q-66 0-113-47t-47-113v-1216q0-66 47-113t113-47h1600q66 0 113 47t47 113z"

{-|-}
picture_o : Color -> Int -> Html msg
picture_o = icon "M576 576q0 80-56 136t-136 56-136-56-56-136 56-136 136-56 136 56 56 136zm1024 384v448h-1408v-192l320-320 160 160 512-512zm96-704h-1600q-13 0-22.5 9.5t-9.5 22.5v1216q0 13 9.5 22.5t22.5 9.5h1600q13 0 22.5-9.5t9.5-22.5v-1216q0-13-9.5-22.5t-22.5-9.5zm160 32v1216q0 66-47 113t-113 47h-1600q-66 0-113-47t-47-113v-1216q0-66 47-113t113-47h1600q66 0 113 47t47 113z"

{-|-}
pie_chart : Color -> Int -> Html msg
...
{-|-}
pied_piper_alt : Color -> Int -> Html msg
...
{-|-}
pinterest_p : Color -> Int -> Html msg
...
{-|-}
pinterest_square : Color -> Int -> Html msg
...
{-|-}
play_circle : Color -> Int -> Html msg
...
{-|-}
question_circle : Color -> Int -> Html msg
...
{-|-}
rotate_left : Color -> Int -> Html msg
...
{-|-}
rotate_right : Color -> Int -> Html msg
rotate_right = icon "M1664 256v448q0 26-19 45t-45 19h-448q-42 0-59-40-17-39 14-69l138-138q-148-137-349-137-104 0-198.5 40.5t-163.5 109.5-109.5 163.5-40.5 198.5 40.5 198.5 109.5 163.5 163.5 109.5 198.5 40.5q119 0 225-52t179-147q7-10 23-12 14 0 25 9l137 138q9 8 9.5 20.5t-7.5 22.5q-109 132-264 204.5t-327 72.5q-156 0-298-61t-245-164-164-245-61-298 61-298 164-245 245-164 298-61q147 0 284.5 55.5t244.5 156.5l130-129q29-31 70-14 39 17 39 59z"

{-|-}
rouble : Color -> Int -> Html msg
...
{-|-}
rss : Color -> Int -> Html msg
rss = icon "M576 1344q0 80-56 136t-136 56-136-56-56-136 56-136 136-56 136 56 56 136zm512 123q2 28-17 48-18 21-47 21h-135q-25 0-43-16.5t-20-41.5q-22-229-184.5-391.5t-391.5-184.5q-25-2-41.5-20t-16.5-43v-135q0-29 21-47 17-17 43-17h5q160 13 306 80.5t259 181.5q114 113 181.5 259t80.5 306zm512 2q2 27-18 47-18 20-46 20h-143q-26 0-44.5-17.5t-19.5-42.5q-12-215-101-408.5t-231.5-336-336-231.5-408.5-102q-25-1-42.5-19.5t-17.5-43.5v-143q0-28 20-46 18-18 44-18h3q262 13 501.5 120t425.5 294q187 186 294 425.5t120 501.5z"

{-|-}
rub : Color -> Int -> Html msg
...
{-|-}
rupee : Color -> Int -> Html msg
rupee = icon "M1345 470v102q0 14-9 23t-23 9h-168q-23 144-129 234t-276 110q167 178 459 536 14 16 4 34-8 18-29 18h-195q-16 0-25-12-306-367-498-571-9-9-9-22v-127q0-13 9.5-22.5t22.5-9.5h112q132 0 212.5-43t102.5-125h-427q-14 0-23-9t-9-23v-102q0-14 9-23t23-9h413q-57-113-268-113h-145q-13 0-22.5-9.5t-9.5-22.5v-133q0-14 9-23t23-9h832q14 0 23 9t9 23v102q0 14-9 23t-23 9h-233q47 61 64 144h171q14 0 23 9t9 23z"

{-|-}
safari : Color -> Int -> Html msg
...
{-|-}
search_plus : Color -> Int -> Html msg
...
{-|-}
share_alt_square : Color -> Int -> Html msg
...
{-|-}
share_square : Color -> Int -> Html msg
...
{-|-}
shirtsinbulk : Color -> Int -> Html msg
...
{-|-}
shopping_bag : Color -> Int -> Html msg
shopping_bag = icon "M1757 1408l35 313q3 28-16 50-19 21-48 21h-1664q-29 0-48-21-19-22-16-50l35-313h1722zm-93-839l86 775h-1708l86-775q3-24 21-40.5t43-16.5h256v128q0 53 37.5 90.5t90.5 37.5 90.5-37.5 37.5-90.5v-128h384v128q0 53 37.5 90.5t90.5 37.5 90.5-37.5 37.5-90.5v-128h256q25 0 43 16.5t21 40.5zm-384-185v256q0 26-19 45t-45 19-45-19-19-45v-256q0-106-75-181t-181-75-181 75-75 181v256q0 26-19 45t-45 19-45-19-19-45v-256q0-159 112.5-271.5t271.5-112.5 271.5 112.5 112.5 271.5z"

{-|-}
shopping_basket : Color -> Int -> Html msg
shopping_basket = icon "M1792 768q53 0 90.5 37.5t37.5 90.5-37.5 90.5-90.5 37.5h-15l-115 662q-8 46-44 76t-82 30h-1280q-46 0-82-30t-44-76l-115-662h-15q-53 0-90.5-37.5t-37.5-90.5 37.5-90.5 90.5-37.5h1792zm-1435 800q26-2 43.5-22.5t15.5-46.5l-32-416q-2-26-22.5-43.5t-46.5-15.5-43.5 22.5-15.5 46.5l32 416q2 25 20.5 42t43.5 17h5zm411-64v-416q0-26-19-45t-45-19-45 19-19 45v416q0 26 19 45t45 19 45-19 19-45zm384 0v-416q0-26-19-45t-45-19-45 19-19 45v416q0 26 19 45t45 19 45-19 19-45zm352 5l32-416q2-26-15.5-46.5t-43.5-22.5-46.5 15.5-22.5 43.5l-32 416q-2 26 15.5 46.5t43.5 22.5h5q25 0 43.5-17t20.5-42zm-1156-1217l-93 412h-132l101-441q19-88 89-143.5t160-55.5h167q0-26 19-45t45-19h384q26 0 45 19t19 45h167q90 0 160 55.5t89 143.5l101 441h-132l-93-412q-11-44-45.5-72t-79.5-28h-167q0 26-19 45t-45 19h-384q-26 0-45-19t-19-45h-167q-45 0-79.5 28t-45.5 72z"

{-|-}
shopping_cart : Color -> Int -> Html msg
...
{-|-}
simplybuilt : Color -> Int -> Html msg
...
{-|-}
sort_alpha_desc : Color -> Int -> Html msg
...
{-|-}
sort_amount_asc : Color -> Int -> Html msg
...
{-|-}
sort_amount_desc : Color -> Int -> Html msg
...
{-|-}
sort_numeric_asc : Color -> Int -> Html msg
...
{-|-}
sort_numeric_desc : Color -> Int -> Html msg
...
{-|-}
space_shuttle : Color -> Int -> Html msg
...
{-|-}
stack_exchange : Color -> Int -> Html msg
...
{-|-}
stack_overflow : Color -> Int -> Html msg
stack_overflow = icon "M1417 1632h-1118v-480h-160v640h1438v-640h-160v480zm-942-524l33-157 783 165-33 156zm103-374l67-146 725 339-67 145zm201-356l102-123 614 513-102 123zm397-378l477 641-128 96-477-641zm-718 1471v-159h800v159h-800z"

{-|-}
star_half_empty : Color -> Int -> Html msg
...
{-|-}
star_half_full : Color -> Int -> Html msg
...
{-|-}
star_half_o : Color -> Int -> Html msg
...
{-|-}
steam_square : Color -> Int -> Html msg
...
{-|-}
step_backward : Color -> Int -> Html msg
...
{-|-}
step_forward : Color -> Int -> Html msg
...
{-|-}
stethoscope : Color -> Int -> Html msg
...
{-|-}
sticky_note_o : Color -> Int -> Html msg
...
{-|-}
sticky_note : Color -> Int -> Html msg
...
{-|-}
stop_circle_o : Color -> Int -> Html msg
stop_circle_o = icon "M896 128q209 0 385.5 103t279.5 279.5 103 385.5-103 385.5-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103zm0 1312q148 0 273-73t198-198 73-273-73-273-198-198-273-73-273 73-198 198-73 273 73 273 198 198 273 73zm-288-224q-14 0-23-9t-9-23v-576q0-14 9-23t23-9h576q14 0 23 9t9 23v576q0 14-9 23t-23 9h-576z"

{-|-}
stop_circle : Color -> Int -> Html msg
stop_circle = icon "M1216 1184v-576q0-14-9-23t-23-9h-576q-14 0-23 9t-9 23v576q0 14 9 23t23 9h576q14 0 23-9t9-23zm448-288q0 209-103 385.5t-279.5 279.5-385.5 103-385.5-103-279.5-279.5-103-385.5 103-385.5 279.5-279.5 385.5-103 385.5 103 279.5 279.5 103 385.5z"

{-|-}
stop : Color -> Int -> Html msg
stop = icon "M1664 192v1408q0 26-19 45t-45 19h-1408q-26 0-45-19t-19-45v-1408q0-26 19-45t45-19h1408q26 0 45 19t19 45z"

{-|-}
street_view : Color -> Int -> Html msg
...
{-|-}
strikethrough : Color -> Int -> Html msg
...
{-|-}
stumbleupon_circle : Color -> Int -> Html msg
...
{-|-}
stumbleupon : Color -> Int -> Html msg
...
{-|-}
superscript : Color -> Int -> Html msg
...
{-|-}
support : Color -> Int -> Html msg
support = icon "M896 0q182 0 348 71t286 191 191 286 71 348-71 348-191 286-286 191-348 71-348-71-286-191-191-286-71-348 71-348 191-286 286-191 348-71zm0 128q-190 0-361 90l194 194q82-28 167-28t167 28l194-194q-171-90-361-90zm-678 1129l194-194q-28-82-28-167t28-167l-194-194q-90 171-90 361t90 361zm678 407q190 0 361-90l-194-194q-82 28-167 28t-167-28l-194 194q171 90 361 90zm0-384q159 0 271.5-112.5t112.5-271.5-112.5-271.5-271.5-112.5-271.5 112.5-112.5 271.5 112.5 271.5 271.5 112.5zm484-217l194 194q90-171 90-361t-90-361l-194 194q28 82 28 167t-28 167z"

{-|-}
table : Color -> Int -> Html msg
...
{-|-}
taxi : Color -> Int -> Html msg
taxi = icon "M1696 896q93 0 158.5 65.5t65.5 158.5v384q0 14-9 23t-23 9h-96v64q0 80-56 136t-136 56-136-56-56-136v-64h-1024v64q0 80-56 136t-136 56-136-56-56-136v-64h-96q-14 0-23-9t-9-23v-384q0-93 65.5-158.5t158.5-65.5h28l105-419q23-94 104-157.5t179-63.5h128v-224q0-14 9-23t23-9h448q14 0 23 9t9 23v224h128q98 0 179 63.5t104 157.5l105 419h28zm-1504 480q66 0 113-47t47-113-47-113-113-47-113 47-47 113 47 113 113 47zm196-480h1016l-89-357q-2-8-14-17.5t-21-9.5h-768q-9 0-21 9.5t-14 17.5zm1212 480q66 0 113-47t47-113-47-113-113-47-113 47-47 113 47 113 113 47z"

{-|-}
television : Color -> Int -> Html msg
...
{-|-}
tencent_weibo : Color -> Int -> Html msg
...
{-|-}
text_height : Color -> Int -> Html msg
...
{-|-}
thumbs_o_down : Color -> Int -> Html msg
...
{-|-}
thumbs_o_up : Color -> Int -> Html msg
...
{-|-}
toggle_left : Color -> Int -> Html msg
toggle_left = icon "M1152 576v640q0 26-19 45t-45 19q-20 0-37-12l-448-320q-27-19-27-52t27-52l448-320q17-12 37-12 26 0 45 19t19 45zm256 800v-960q0-13-9.5-22.5t-22.5-9.5h-960q-13 0-22.5 9.5t-9.5 22.5v960q0 13 9.5 22.5t22.5 9.5h960q13 0 22.5-9.5t9.5-22.5zm256-960v960q0 119-84.5 203.5t-203.5 84.5h-960q-119 0-203.5-84.5t-84.5-203.5v-960q0-119 84.5-203.5t203.5-84.5h960q119 0 203.5 84.5t84.5 203.5z"

{-|-}
toggle_off : Color -> Int -> Html msg
...
{-|-}
transgender_alt : Color -> Int -> Html msg
...
{-|-}
tripadvisor : Color -> Int -> Html msg
...
{-|-}
tumblr_square : Color -> Int -> Html msg
...
{-|-}
turkish_lira : Color -> Int -> Html msg
...
{-|-}
twitter_square : Color -> Int -> Html msg
...
{-|-}
undo : Color -> Int -> Html msg
undo = icon "M1664 896q0 156-61 298t-164 245-245 164-298 61q-172 0-327-72.5t-264-204.5q-7-10-6.5-22.5t8.5-20.5l137-138q10-9 25-9 16 2 23 12 73 95 179 147t225 52q104 0 198.5-40.5t163.5-109.5 109.5-163.5 40.5-198.5-40.5-198.5-109.5-163.5-163.5-109.5-198.5-40.5q-98 0-188 35.5t-160 101.5l137 138q31 30 14 69-17 40-59 40h-448q-26 0-45-19t-19-45v-448q0-42 40-59 39-17 69 14l130 129q107-101 244.5-156.5t284.5-55.5q156 0 298 61t245 164 164 245 61 298z"

{-|-}
university : Color -> Int -> Html msg
...
{-|-}
unlink : Color -> Int -> Html msg
unlink = icon "M503 1271l-256 256q-10 9-23 9-12 0-23-9-9-10-9-23t9-23l256-256q10-9 23-9t23 9q9 10 9 23t-9 23zm169 41v320q0 14-9 23t-23 9-23-9-9-23v-320q0-14 9-23t23-9 23 9 9 23zm-224-224q0 14-9 23t-23 9h-320q-14 0-23-9t-9-23 9-23 23-9h320q14 0 23 9t9 23zm1264 128q0 120-85 203l-147 146q-83 83-203 83-121 0-204-85l-334-335q-21-21-42-56l239-18 273 274q27 27 68 27.5t68-26.5l147-146q28-28 28-67 0-40-28-68l-274-275 18-239q35 21 56 42l336 336q84 86 84 204zm-617-724l-239 18-273-274q-28-28-68-28-39 0-68 27l-147 146q-28 28-28 67 0 40 28 68l274 274-18 240q-35-21-56-42l-336-336q-84-86-84-204 0-120 85-203l147-146q83-83 203-83 121 0 204 85l334 335q21 21 42 56zm633 84q0 14-9 23t-23 9h-320q-14 0-23-9t-9-23 9-23 23-9h320q14 0 23 9t9 23zm-544-544v320q0 14-9 23t-23 9-23-9-9-23v-320q0-14 9-23t23-9 23 9 9 23zm407 151l-256 256q-11 9-23 9t-23-9q-9-10-9-23t9-23l256-256q10-9 23-9t23 9q9 10 9 23t-9 23z"

{-|-}
unlock_alt : Color -> Int -> Html msg
...
{-|-}
user_secret : Color -> Int -> Html msg
...
{-|-}
users : Color -> Int -> Html msg
users = icon "M529 896q-162 5-265 128h-134q-82 0-138-40.5t-56-118.5q0-353 124-353 6 0 43.5 21t97.5 42.5 119 21.5q67 0 133-23-5 37-5 66 0 139 81 256zm1071 637q0 120-73 189.5t-194 69.5h-874q-121 0-194-69.5t-73-189.5q0-53 3.5-103.5t14-109 26.5-108.5 43-97.5 62-81 85.5-53.5 111.5-20q10 0 43 21.5t73 48 107 48 135 21.5 135-21.5 107-48 73-48 43-21.5q61 0 111.5 20t85.5 53.5 62 81 43 97.5 26.5 108.5 14 109 3.5 103.5zm-1024-1277q0 106-75 181t-181 75-181-75-75-181 75-181 181-75 181 75 75 181zm704 384q0 159-112.5 271.5t-271.5 112.5-271.5-112.5-112.5-271.5 112.5-271.5 271.5-112.5 271.5 112.5 112.5 271.5zm576 225q0 78-56 118.5t-138 40.5h-134q-103-123-265-128 81-117 81-256 0-29-5-66 66 23 133 23 59 0 119-21.5t97.5-42.5 43.5-21q124 0 124 353zm-128-609q0 106-75 181t-181 75-181-75-75-181 75-181 181-75 181 75 75 181z"

{-|-}
venus_double : Color -> Int -> Html msg
...
{-|-}
video_camera : Color -> Int -> Html msg
...
{-|-}
vimeo_square : Color -> Int -> Html msg
...
{-|-}
volume_down : Color -> Int -> Html msg
...
{-|-}
warning : Color -> Int -> Html msg
warning = icon "M1024 1375v-190q0-14-9.5-23.5t-22.5-9.5h-192q-13 0-22.5 9.5t-9.5 23.5v190q0 14 9.5 23.5t22.5 9.5h192q13 0 22.5-9.5t9.5-23.5zm-2-374l18-459q0-12-10-19-13-11-24-11h-220q-11 0-24 11-10 7-10 21l17 457q0 10 10 16.5t24 6.5h185q14 0 23.5-6.5t10.5-16.5zm-14-934l768 1408q35 63-2 126-17 29-46.5 46t-63.5 17h-1536q-34 0-63.5-17t-46.5-46q-37-63-2-126l768-1408q17-31 47-49t65-18 65 18 47 49z"

{-|-}
wechat : Color -> Int -> Html msg
...
{-|-}
wikipedia_w : Color -> Int -> Html msg
...
{-|-}
xing_square : Color -> Int -> Html msg
...
{-|-}
y_combinator_square : Color -> Int -> Html msg
...
{-|-}
y_combinator : Color -> Int -> Html msg
...
{-|-}
youtube_square : Color -> Int -> Html msg
